...
public class SfWebBaseApp {

    private static final Logger log = LoggerFactory.getLogger(SfWebBaseApp.class);

    private final Environment env;

    public SfWebBaseApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes sf_web_base.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SfWebBaseApp.class);
