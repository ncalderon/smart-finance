...
public class BankAccountResourceIntTest {
    ...
    private static final AccountType DEFAULT_ACCOUNT_TYPE = AccountType.DEFAULT;
    private static final AccountType UPDATED_ACCOUNT_TYPE = AccountType.CREDIT_CARD;
