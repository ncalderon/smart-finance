...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', () => {
        ...
        expect(bankAccountComponentsPage.getTitle()).toMatch(/sfWebBaseApp.bankAccount.home.title/);
    ...
    it('should load create BankAccount dialog', () => {
        ...
        expect(bankAccountDialogPage.getModalTitle()).toMatch(/sfWebBaseApp.bankAccount.home.createOrEditLabel/);
