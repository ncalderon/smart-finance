...
describe('Bank e2e test', () => {
    ...
    it('should load Banks', () => {
        ...
        expect(bankComponentsPage.getTitle()).toMatch(/sfWebBaseApp.bank.home.title/);
    ...
    it('should load create Bank dialog', () => {
        ...
        expect(bankDialogPage.getModalTitle()).toMatch(/sfWebBaseApp.bank.home.createOrEditLabel/);
