...
describe('TranCategoryRegex e2e test', () => {
    ...
    it('should load TranCategoryRegexes', () => {
        ...
        expect(tranCategoryRegexComponentsPage.getTitle()).toMatch(/sfWebBaseApp.tranCategoryRegex.home.title/);
    ...
    it('should load create TranCategoryRegex dialog', () => {
        ...
        expect(tranCategoryRegexDialogPage.getModalTitle()).toMatch(/sfWebBaseApp.tranCategoryRegex.home.createOrEditLabel/);
