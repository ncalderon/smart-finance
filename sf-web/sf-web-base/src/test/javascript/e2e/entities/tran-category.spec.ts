...
describe('TranCategory e2e test', () => {
    ...
    it('should load TranCategories', () => {
        ...
        expect(tranCategoryComponentsPage.getTitle()).toMatch(/sfWebBaseApp.tranCategory.home.title/);
    ...
    it('should load create TranCategory dialog', () => {
        ...
        expect(tranCategoryDialogPage.getModalTitle()).toMatch(/sfWebBaseApp.tranCategory.home.createOrEditLabel/);
