...
describe('Bank e2e test', () => {
    ...
    it('should load Banks', () => {
        ...
        expect(bankComponentsPage.getTitle()).toMatch(/sfWebAdminApp.bank.home.title/);
    ...
    it('should load create Bank dialog', () => {
        ...
        expect(bankDialogPage.getModalTitle()).toMatch(/sfWebAdminApp.bank.home.createOrEditLabel/);
