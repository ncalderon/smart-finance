...
describe('TranCategoryRegex e2e test', () => {
    ...
    it('should load TranCategoryRegexes', () => {
        ...
        expect(tranCategoryRegexComponentsPage.getTitle()).toMatch(/sfWebAdminApp.tranCategoryRegex.home.title/);
    ...
    it('should load create TranCategoryRegex dialog', () => {
        ...
        expect(tranCategoryRegexDialogPage.getModalTitle()).toMatch(/sfWebAdminApp.tranCategoryRegex.home.createOrEditLabel/);
    ...
    it('should create and save TranCategoryRegexes', () => {
        ...
        tranCategoryRegexDialogPage.setCategoryRegexInput('categoryRegex');
        expect(tranCategoryRegexDialogPage.getCategoryRegexInput()).toMatch('categoryRegex');
...
export class TranCategoryRegexDialogPage {
    ...
    categoryRegexInput = element(by.css('input#field_categoryRegex'));
    ...
    setCategoryRegexInput = function (categoryRegex) {
        this.categoryRegexInput.sendKeys(categoryRegex);
    }

    getCategoryRegexInput = function () {
        return this.categoryRegexInput.getAttribute('value');
    }
