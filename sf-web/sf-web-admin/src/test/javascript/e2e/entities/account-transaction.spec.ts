...
describe('AccountTransaction e2e test', () => {
    ...
    it('should load AccountTransactions', () => {
        ...
        expect(accountTransactionComponentsPage.getTitle()).toMatch(/sfWebAdminApp.accountTransaction.home.title/);
    ...
    it('should load create AccountTransaction dialog', () => {
        ...
        expect(accountTransactionDialogPage.getModalTitle()).toMatch(/sfWebAdminApp.accountTransaction.home.createOrEditLabel/);
