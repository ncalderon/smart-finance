...
public class SfWebAdminApp {

    private static final Logger log = LoggerFactory.getLogger(SfWebAdminApp.class);

    private final Environment env;

    public SfWebAdminApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes sf_web_admin.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SfWebAdminApp.class);
