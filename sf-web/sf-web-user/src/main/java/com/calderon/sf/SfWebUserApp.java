...
public class SfWebUserApp {

    private static final Logger log = LoggerFactory.getLogger(SfWebUserApp.class);

    private final Environment env;

    public SfWebUserApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes sf_web_user.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SfWebUserApp.class);
