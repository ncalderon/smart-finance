...
public class Transaction {
    ...
    private LocalDate tranPostDate;
    ...
    public static class Builder {
        ...
        public LocalDate getTranPostDate() {
            return tranPostDate;
        }

        public Builder setTranPostDate(Timestamp tranPostDate) {
            this.tranPostDate = tranPostDate.toLocalDateTime().toLocalDate();
            return this;
        }
        ...
        public Builder setTranPostDate(LocalDateTime tranPostDate) {
            this.tranPostDate = tranPostDate.toLocalDate();
            return this;
        }
    ...
    public Timestamp getTimestampTranPostDate(){
        return TimeUtil.newTimestampFrom(tranPostDate);
    }

    public void setTranPostDate(LocalDate tranPostDate) {
        this.tranPostDate = tranPostDate;
    }
